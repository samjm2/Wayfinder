...
Rules:
- Use ONLY values that appear in DATA. Never invent, guess, or infer a value that isn't there. If nothing in DATA fits, return value: null.
...
- SENSITIVE fields are NEVER filled. If a field asks for a Social Security Number (SSN), Alien/A-Number, USCIS account number, passport number, any bank/financial/card number, a password, or a signature, return sensitive: true and value: null.
